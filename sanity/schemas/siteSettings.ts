export default {
  ...
  fieldsets: [
    ...
    {
      name: 'visibilityAndForms',
      title: '5. Visibilidad (Ocultar Formulario y Botones)',
      options: { collapsible: true, collapsed: false },
    },
    {
      name: 'integrations',
      title: '6. Integraciones (Google Sheets)',
      options: { collapsible: true, collapsed: false },
    },
  ],
  fields: [
    ...
    },
    {
      ...
      type: 'boolean',
      fieldset: 'visibilityAndForms',
      initialValue: false,
      description: 'Si se activa, el formulario de registro se ocultará en la página web manteniendo los datos de soporte. También oculta automáticamente el botón Early Access del Header.',
    },
    {
      name: 'hideHeaderCta',
      title: 'Ocultar Botón Early Access del Header',
      type: 'boolean',
      fieldset: 'visibilityAndForms',
      initialValue: false,
      description: 'Oculta el botón Early Access del menú superior (Header) independientemente del formulario.',
    },
    {
